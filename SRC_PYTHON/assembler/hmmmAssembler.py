...
OldDict = {"halt":"halt", "read":"read", "write":"write", "nop":"nop", "loadn":"loadn", "addn":"addn", "mov":"mov", "add":"add",
           "sub":"sub", "neg":"neg", "mul":"mul", "div":"div", "mod":"mod", "jump":"jump", "jeqz":"jeqz", "jnez":"jnez",
           "jgtz":"jgtz", "jltz":"jltz", "call":"call", "jumpi":"jumpi", "load":"load", "store":"store", "loadi":"loadi", "storei":"storei"}

NewDict = {"halt":"halt", "read":"read", "write":"write", "nop":"nop", "setn":"loadn", "addn":"addn", "mov":"mov", "copy":"mov",
           "add":"add",
           "sub":"sub", "neg":"neg", "mul":"mul", "div":"div", "mod":"mod", "jumpn":"jump", "jeqz":"jeqz", "jeqzn":"jeqz",
           "jnez":"jnez", "jnezn":"jnez", "jgtz":"jgtz", "jgtzn":"jgtz", "jltz":"jltz", "jtlzn":"jltz", "call":"call", "calln":"call",
           "jump":"jumpi", "jumpr":"jumpi", "loadn":"load", "storen":"store", "load":"loadi", "loadi":"loadi", "loadr":"loadi",
